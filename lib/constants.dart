...
const String URL_LOGIN = "/usuarios/login";

const String URL_USUARIO = "/usuarios";
...
const Color COLOR_PRIMARY = const Color(0xFF424F91);
const Color COLOR_SECONDARY = const Color(0xff071f4d);
